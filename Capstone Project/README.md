...
### Task: Explain the task you are going to be solving with this dataset and the features you will be using for it.
...
### Access: Explain how you are accessing the data in your workspace.
...
## Automated ML: Give an overview of the `automl` settings and configuration you used for this experiment
...
### HuperDrive Results What are the results you got with your model? What were the parameters of the model? How could you have improved it?
...
1. The top perofrming model had an accuracy of 81.6% with the following parameters:
{'Regularization Strength:': 1000.0,
 'Max iterations:': 20,
 'accuracy': 0.8161137440758294}
2. The second best model had an accuracy of 81.6% with the following parameters:



## Model Deployment Give an overview of the deployed model and instructions on how to query the endpoint with a sample input.
